...
## Start script
require(ggplot2)
setwd("~/src/mvp_exome_qc/bin")
source("./fastqc_helper.R")

# Build reference
reference_filename = '~/src/mvp_exome_qc/data/IonTorrent_NA12878_V3.fastqc_data.txt'
...
for (i in 1:length(sample_files)) {
  ...
  row = data.frame("SampleName" = sample_name, "MeanBaseQuality" = mean_base_quality, 
                   ...
                   "MeanGCContent" = mean_gc_content, "HighKmerContent" = kmer_content)
