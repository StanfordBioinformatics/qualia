...
#
# This file was autogenerated by process: '/Users/gmcinnes/src/ClaritasExomeAnalysis/logs/CLA00131'
# ...from working directory: 'transfer_from_drive.py --search'
#
...
if __name__ == '__main__' :
    writeDotGraph(os.path.join(scriptDir,'pyflow_tasks_info.txt'),os.path.join(scriptDir,'pyflow_tasks_runstate.txt'),'TransferWorkflow')
